...
if (isset($_SESSION["login"])) {
    ...
    $result_login = mysqli_query($conn, "SELECT * FROM user_rizaldi WHERE email = '$login_as'");
...
<body>
    ...
    <nav class="navbar navbar-expand navbar-dark bg-<?= isset($_COOKIE["warna_navbar"])  ? $_COOKIE["warna_navbar"] : "success"; ?>">
        <div class="container py-2">
            <div class="navbar-nav">
                <a class="nav-link" href="Home-Rizaldi.php">Home</a>
                <a class="nav-link" href="ListCar-Rizaldi.php">MyCar</a>
            </div>
            <div class="d-flex">
                <a href="Add-Rizaldi.php" class="btn btn-light text-<?= isset($_COOKIE["warna_navbar"])  ? $_COOKIE["warna_navbar"] : "primary"; ?>" role="button">Add Car</a>
                <div class="dropdown ms-4">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item text-<?= isset($_COOKIE["warna_navbar"])  ? $_COOKIE["warna_navbar"] : "success"; ?>" href="Logout.php">Log Out</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="container mt-4">
        ...
        <div class="d-flex align-items-center logo-ead">
            ...
            <span class="ms-5 text-muted">Rizaldi_1202204251</span>
        </div>
    </div>
